...
/* FreeMASTER CAN Supports only up to 64 MB */
#if (FMSTR_FLEXCAN_RXMB > 63) || (FMSTR_FLEXCAN_TXMB > 63)
#error "FMSTR_CAN_RXMB and FMSTR_CAN_TXMB must be in the 0-63 MB interval"
#endif
...
#define FMSTR_FLEXCAN_RXMB_BIT           0x00000001 << (FMSTR_FLEXCAN_RXMB % 32)
#define FMSTR_FLEXCAN_TXMB_BIT           0x00000001 << (FMSTR_FLEXCAN_TXMB % 32)
#define FMSTR_FLEXCAN_RXMB_INDEX         ((int)(FMSTR_FLEXCAN_RXMB / 32))
#define FMSTR_FLEXCAN_TXMB_INDEX         ((int)(FMSTR_FLEXCAN_TXMB / 32))
...
static const FMSTR_U8 FMSTR_FCAN_IMASK_OFFSETS[] = {
	0x28,           /* FMSTR_FCAN_IMASK1_OFFSET - Interrupt enable mask for  0-31 MB interval */
	0x24            /* FMSTR_FCAN_IMASK2_OFFSET - Interrupt enable mask for 32-63 MB interval */
};

static const FMSTR_U8 FMSTR_FCAN_IFLAG_OFFSETS[] = {
	0x30,           /* FMSTR_FCAN_IFLAG1_OFFSET - Interrupt active flag for  0-31 MB interval */
	0x2C            /* FMSTR_FCAN_IFLAG2_OFFSET - Interrupt active flag for 32-63 MB interval */
};
...
static FMSTR_BOOL _FMSTR_S32_Init(FMSTR_U32 idRx, FMSTR_U32 idTx)
{
    ...
    if (fmstr_CANBaseAddr != 0)
    {
        ...
        if (FMSTR_GETFIELD32(fmstr_CANBaseAddr, FMSTR_FCAN_MCR_OFFSET, FMSTR_FCAN_MCR_MAXMB_SHIFT, FMSTR_FCAN_MCR_MAXMB_MASK) < FMSTR_MAX(FMSTR_FLEXCAN_RXMB, FMSTR_FLEXCAN_TXMB))
        {
            FMSTR_SETFIELD32(fmstr_CANBaseAddr, FMSTR_FCAN_MCR_OFFSET, FMSTR_FCAN_MCR_MAXMB_SHIFT, FMSTR_FCAN_MCR_MAXMB_MASK, FMSTR_MAX(FMSTR_FLEXCAN_RXMB, FMSTR_FLEXCAN_TXMB));
        }
...
static void _FMSTR_S32_EnableTxInterrupt(FMSTR_BOOL enable)
{
    ...
    if (enable)
    {
        FMSTR_SETBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IMASK_OFFSETS[FMSTR_FLEXCAN_TXMB_INDEX], FMSTR_FLEXCAN_TXMB_BIT);
    }
    else
    {
        FMSTR_CLRBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IMASK_OFFSETS[FMSTR_FLEXCAN_TXMB_INDEX], FMSTR_FLEXCAN_TXMB_BIT);
    }
    /* Check interrupt flag */
    while (FMSTR_TSTBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IFLAG_OFFSETS[FMSTR_FLEXCAN_TXMB_INDEX], FMSTR_FLEXCAN_TXMB_BIT))
    {
        /* Clear interrupt flag by writing the value 1 again (w1c) */
        FMSTR_SETBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IFLAG_OFFSETS[FMSTR_FLEXCAN_TXMB_INDEX], FMSTR_FLEXCAN_TXMB_BIT);
    }
}
...
static void _FMSTR_S32_EnableRxInterrupt(FMSTR_BOOL enable)
{
    ...
    if (enable)
    {
        FMSTR_SETBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IMASK_OFFSETS[FMSTR_FLEXCAN_RXMB_INDEX], FMSTR_FLEXCAN_RXMB_BIT);
    }
    else
    {
        FMSTR_CLRBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IMASK_OFFSETS[FMSTR_FLEXCAN_RXMB_INDEX], FMSTR_FLEXCAN_RXMB_BIT);
    }

    /* Check interrupt flag */
    while (FMSTR_TSTBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IFLAG_OFFSETS[FMSTR_FLEXCAN_RXMB_INDEX], FMSTR_FLEXCAN_RXMB_BIT))
    {
        /* Clear interrupt flag by writing the value 1 again (w1c) */
        FMSTR_SETBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IFLAG_OFFSETS[FMSTR_FLEXCAN_RXMB_INDEX], FMSTR_FLEXCAN_RXMB_BIT);
    }
}
...
static FMSTR_SIZE8 _FMSTR_S32_GetRxFrameLen(void)
{
    ...
    if (FMSTR_TSTBIT32(fmstr_CANBaseAddr, FMSTR_FCAN_IFLAG_OFFSETS[FMSTR_FLEXCAN_RXMB_INDEX], FMSTR_FLEXCAN_RXMB_BIT))
    {
